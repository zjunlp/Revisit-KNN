...
def _setup_parser():
    ...
    parser.add_argument("--model_class", type=str, default="roberta.RobertaForPrompt")
    ...
    parser.add_argument("--knn_infer", action="store_true", default=False)
    parser.add_argument("--train_with_knn", action="store_true", default=False)
    parser.add_argument("--ft_with_knn", action="store_true", default=False)
    parser.add_argument("--ssl", action='store_true', default=False)
    parser.add_argument("--not_train", action='store_true', default=False)
    parser.add_argument("--knn_only", action='store_true', default=False)
...
def main():
    ...
    with open(os.path.join(args.data_dir, 'rel2id.json'), 'r', encoding='utf-8') as reader:
    ...
    early_callback = pl.callbacks.EarlyStopping(monitor="Eval/f1", mode="max", patience=5,check_on_train_epoch_end=True)
    ...
    if 'Embedding' not in args.litmodel_class and not args.not_train:
