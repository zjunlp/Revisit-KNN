...
OUTPUT_DIR=ckpt/pt_16shot_infer/$TASK-$K-$SEED/$REAL_BS-$LR

CKPT_DIR=ckpt/pt_16shot/$TASK-$K-$SEED/$REAL_BS-$LR
...
# if only integrating kNN into inference, please add these two commands:
#   --only_knn_infer \
#   --ssl
