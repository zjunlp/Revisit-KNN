...
class BooqProcessor(DataProcessor):
    ...
    def _create_examples(self, lines, set_type):
        ...
        for (i, line) in enumerate(lines):
            ...
            label = line['label']
            examples.append(InputExample(guid=guid, text_a=passage, text_b=question, label=int(label)))
        return examples
...
class CBProcessor(DataProcessor):
    ...
    def _create_examples(self, lines, set_type):
        ...
        for (i, line) in enumerate(lines):
            ...
            label = line['label']
            examples.append(InputExample(guid=guid, text_a=premise, text_b=hypothesis, label=self.word2label[label]))
        return examples
...
def f1_metrics(task_name, preds, labels):
